...
// Prediction: "The murderer is Miss Scarlett"
...
// Prediction: TypeError. A constant variable cannot be updated
```
...
// Prediction: "The suspects are Miss Scarlet, Professor Plum and Colonel Mustard. Suspect three is Mrs Peacock."
```
